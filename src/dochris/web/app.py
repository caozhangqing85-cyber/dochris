...
# Tab 子模块
from .compile_tab import create_compile_tab, get_compile_info
from .file_tab import create_file_tab
from .graph_tab import create_graph_tab
from .quality_tab import create_quality_tab
...
from .compile_tab import handle_compile  # noqa: F401
from .file_tab import (  # noqa: F401
    _get_file_table,
    handle_refresh_files,
    handle_upload,
)
from .graph_tab import _handle_graph_refresh  # noqa: F401
